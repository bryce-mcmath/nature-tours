        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              (0, _alert.showAlert)(res.data.status, res.data.message);
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              console.log('success:', res);
              (0, _alert.showAlert)(res.data.status, 'Signed up successfully!');
              setTimeout(function () {
                location.assign('/');
              }, 1000);
            } else {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              console.log('success:', res);
              (0, _alert.showAlert)(res.data.status, 'Account info updated successfully!');
            } else {
              console.log('error:', res);
              (0, _alert.showAlert)('error', res.data.message);
            }
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYnJ5Y2VtY21hdGgiLCJhIjoiY2w0M2RtNjNmMDN0MzNpcGhidWV0MGdobiJ9.TZrRH-kvN7xqrO_QSdsnPw';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extend bounds to include current locations
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_cGdGk1uF0FDXf4Pw3XAkp2PW00H0bGmfwJ'); // Get session from server
...
var updateForm = document.getElementById('updateData');
...
var passwordForm = document.getElementById('updatePassword');
